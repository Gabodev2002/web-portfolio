       ...
       <section className={`${styles.sectionContainer}  mt-35 px-8 lg:px-12 max-w-6xl m-auto`}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 h-auto w-full max-w-7xl m-auto mt-10 md:mt-20'>
            ...
            <div className='w-full h-[450px] flex justify-center'>
                <Image className='bg-cover rounded-2xl' style={maskImage} width={400} height={450} src="/fotocv.webp" alt="foto-cv" priority />
            </div>
        ...
        <div className='mt-10 md:mt-44'>
            ...
            <div className='flex flex-wrap items-center justify-center gap-8 py-20 m-auto max-w-3xl'>
        ...
        <div className='my-10 md:my-20'>
            <h1 className='text-4xl md:text-5xl z-10'>Contact</h1>
               ...
               <SpotLightContainer>
                    <div className='z-10'>
                        ...
                        <div className='flex flex-col items-center gap-5'>
                            ...
                            <p>Github: <a href="https://github.com/gabodev2002" target="_blank" rel="noopener noreferrer">github.com/gabodev2002</a></p>
                        </div>
                    </div>
                </SpotLightContainer>
            </div>
