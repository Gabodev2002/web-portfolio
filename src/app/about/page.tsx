...
export default function AboutPage () {
    return (
       <section className={`${styles.sectionContainer}  mt-20 px-8 lg:px-12 max-w-6xl m-auto`}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 h-auto w-full max-w-7xl m-auto mt-10 md:mt-20'>
            ...
            <div className='w-full h-[450px] flex justify-center'>
                <Image className='bg-cover rounded-2xl' style={maskImage} width={450} height={450} src="/fotocv.webp" alt="foto-cv" priority />
            </div>
