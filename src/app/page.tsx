   ...
   <div ref={containerRef}>
      ...
      <section ref={videoContainerRef} className={`${styles.mainContainer}`}>
          <video className='w-full h-full absolute object-cover' autoPlay={true} loop muted src="./Cover-30-04.mp4"></video>
            ...
            <button onClick={() => handleStart()} className="absolute bottom-6 left-1/2 -translate-x-1/2 w-auto h-auto animate-bounce cursor-pointer"><IoMdArrowDropdown color='#00FFFF' size={70}/></button>
      </section>
