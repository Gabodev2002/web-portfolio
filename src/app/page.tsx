   ...
   <div ref={containerRef}>
      ...
      <section ref={videoContainerRef} className={`${styles.mainContainer}`}>
          <video className='w-full h-full absolute object-cover' autoPlay={true} loop muted src="./Cover-30-04.mp4"></video>
            <h1 ref={headerTextRef} className={`${isActive ? styles['out-animation'] : ''} ${isAnimationSlideIn ? styles['in-animation'] : ''} text-4xl md:text-6xl z-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2`}>
