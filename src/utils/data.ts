...
export const dataProjects: DataProjects[] = [
    ...
    {name: 'Movie App', description: `I'm designed and built a modern streaming application from the ground up, deployed live on Vercel. This project showcases my expertise in crafting intuitive, high-performance user interfaces using React and TypeScript..`, imageUrl: '/peliapp-front.webp', websiteUrl: '', imageSizes: { width: 470, height: 470, maxWidth: 470, maxHeight: 470}}, 
